...
export default function LineChartDatePicker(): JSX.Element {
  useEffect(() => {
    const date_picker_element: any = document.querySelector(".line-date-picker");
    const selected_date_element: any = document.querySelector(
      ".line-date-picker .selected-date"
    );
    const dates_element: any = document.querySelector(".line-date-picker .dates");
    const mth_element: any = document.querySelector(
      ".line-date-picker .dates .month .mth"
    );
    const next_mth_element: any = document.querySelector(
      ".line-date-picker .dates .month .next-mth"
    );  
    const prev_mth_element: any = document.querySelector(
      ".line-date-picker .dates .month .prev-mth"
    );
    const days_element: any = document.querySelector(
      ".line-date-picker .dates .days"
    );
    const days: any = document.querySelector(".line-date-picker .dates .top-day");
  ...
  return (
    <div className="line-date-picker">
